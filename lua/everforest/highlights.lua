...
highlights.generate_syntax = function(palette, options)
	...
	local syntax = {
		...
		CursorLine = syntax_entry(palette.none, palette.bg3),
		...
		MatchParen = syntax_entry(palette.none, palette.bg3),
		...
		NormalFloat = syntax_entry(palette.fg, (options.float_style == "bright" and palette.bg3) or palette.bg_dim),
		...
		PmenuSel = syntax_entry(palette.fg, palette.statusline1),
		PmenuThumb = syntax_entry(palette.none, palette.bg3),
		...
		-- hrsh7th/nvim-cmp
		CmpItemAbbrMatch = syntax_entry(palette.fg, palette.none, { styles.bold }),
		...
		GitSignsCurrentLineBlame = { link = "Aqua" },
		...
		MiniIndentscopeSymbol = { link = "Aqua" },
